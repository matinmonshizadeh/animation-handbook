...
.hb-view>.hb-side{grid-area:side;width:auto;min-width:0;min-height:0;overflow:hidden;display:flex;flex-direction:column;gap:18px;
  padding:18px 18px 0;background:var(--hb-panel);border:1px solid var(--hb-line);border-radius:10px}
.hb-head{margin:0;flex:none}
...
.hb-settings{display:flex;flex-direction:column;gap:10px;flex:1 1 auto;min-height:0;overflow-y:auto;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:#2a2a30 transparent}
...
/* Prompt box and Read more stay visible at the bottom of the column; the settings above scroll on their own */
.hb-take{margin-top:auto;flex:none;display:flex;flex-direction:column;gap:10px;padding:12px 0 18px;background:var(--hb-panel);border-top:1px solid var(--hb-line)}
